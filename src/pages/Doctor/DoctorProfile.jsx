      ...
      <div className="flex flex-col gap-4 m-5">
        ...
        <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
          ...
          <div className="flex gap-2 py-2">
            ...
            <br />
            <p className="text-sm">{isEdit ? <input type="text" onChange={(e) => setProfileData((prev) => ({...prev,address:{...prev.address,line2:e.target.value}}))} value={profileData.address.line2}/> :profileData.address.line2}</p>
          </div>
